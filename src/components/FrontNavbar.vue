<template>
  <nav  class="navbar navbar-expand-lg py-0 navbar-dark fixed-top z-index-3" style="background-color:rgba(0,0,0,.2);">
    <div class="container-fluid container">
      <router-link class="navbar-brand" to="/">威爾森的猴樂園</router-link>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="margin-top:8px">
          <li class="nav-item h5">
            <router-link class="nav-link" to="/" replace>首頁</router-link>
          </li>
          <li class="nav-item">
      ...
      </div><router-link class="nav-link" to="/cart" append>
